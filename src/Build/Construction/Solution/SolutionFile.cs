    ...
    public sealed class SolutionFile
    {
        ...
        internal string FullPath
        {
            ...
            set
            {
                ...
                VerifyThrowInternalRooted(value);
        ...
        {
            VerifyThrow(!String.IsNullOrEmpty(solutionFile), "null solution file passed to GetSolutionFileMajorVersion!");
            VerifyThrowInternalRooted(solutionFile);
        ...
        {
            VerifyThrow(SolutionReader != null, "ParseFileHeader(): reader is null!");
        ...
        {
            VerifyThrow(!string.IsNullOrEmpty(_solutionFile), "ParseSolutionFile() got a null solution file!");
            VerifyThrowInternalRooted(_solutionFile);
        ...
        {
            VerifyThrow(!string.IsNullOrEmpty(firstLine), "ParseProject() got a null firstLine!");
            VerifyThrow(SolutionReader != null, "ParseProject() got a null reader!");
        ...
        private void ValidateProjectRelativePath(ProjectInSolution proj)
        {
            ...
            VerifyThrow(proj.RelativePath != null, "Project relative path cannot be null.");
