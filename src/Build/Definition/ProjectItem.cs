...
namespace Microsoft.Build.Evaluation
{
    ...
    public class ProjectItem : IItem<ProjectMetadata>, IProjectMetadataParent
    {
                            ...
                            )
        {
            ...
            VerifyThrowArgumentNull(evaluatedIncludeEscaped, nameof(evaluatedIncludeEscaped));
            VerifyThrowArgumentNull(evaluatedIncludeBeforeWildcardExpansionEscaped, nameof(evaluatedIncludeBeforeWildcardExpansionEscaped));
        ...
        public bool RemoveMetadata(string name)
        {
            ...
            if (metadatum == null)
            {
                ...
                VerifyThrowInvalidOperation(itemDefinitionMetadata == null, "OM_CannotRemoveMetadataOriginatingFromItemDefinition", name);
                return false;
            }
        ...
        {
            VerifyThrowArgumentLength(newItemType, "ItemType");
            Project.VerifyThrowInvalidOperationNotImported(_xml.ContainingProject);
            VerifyThrowInvalidOperation(_xml.Parent?.Parent != null, "OM_ObjectIsNoLongerActive");
        ...
        internal class ProjectItemFactory : IItemFactory<ProjectItem, ProjectItem>
        {
            ...
            public string ItemType
            {
                ...
                set { ThrowInternalError("Cannot change the item type on ProjectItem.ProjectItemFactory"); }
            }
            ...
            {
                VerifyThrowInternalNull(_xml, "xml");
