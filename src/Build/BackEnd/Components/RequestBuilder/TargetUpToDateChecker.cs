...
namespace Microsoft.Build.BackEnd
{
    ...
    internal sealed class TargetUpToDateChecker
    {
        ...
        private bool IsOutOfDate(string input, string output, string inputItemName, string outputItemName)
        {
            ...
            ProjectErrorUtilities.VerifyThrowInvalidProject(NativeMethodsShared.HasInvalidPathCharacters(input), _project.ProjectFileLocation, "IllegalCharactersInFileOrDirectory", input, inputItemName);
            ProjectErrorUtilities.VerifyThrowInvalidProject(NativeMethodsShared.HasInvalidPathCharacters(output), _project.ProjectFileLocation, "IllegalCharactersInFileOrDirectory", output, outputItemName);
