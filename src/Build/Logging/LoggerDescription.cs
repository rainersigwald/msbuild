    ...
    public class LoggerDescription : ITranslatable
    {
        ...
        private ILogger CreateLogger(bool forwardingLogger)
        {
            ...
            catch (InvalidCastException e)
            {
                ...
                string message = FormatResourceStringStripCodeAndKeyword("LoggerInstantiationFailureErrorInvalidCast", _loggerClassName, _loggerAssembly.AssemblyLocation, e.Message);
