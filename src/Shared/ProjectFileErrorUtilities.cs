...
namespace Microsoft.Build.Shared
{
    ...
    static internal class ProjectFileErrorUtilities
    {
        ...
        /// VerifyThrow(), because VerifyThrow() is used to flag internal/programming errors.
        ///
        ...
        {
            VerifyThrow(projectFile != null, "Must specify the invalid project file. If project file is not available, use VerifyThrowInvalidProject() and pass in the XML node instead.");
