...
namespace Microsoft.Build.Utilities
{
    ...
    public static class ToolLocationHelper
    {
        ...
        {
            VerifyThrowArgumentLength(registryRoot, nameof(registryRoot));
            VerifyThrowArgumentLength(registryKeySuffix, nameof(registryKeySuffix));
            VerifyThrowArgumentLength(targetFrameworkVersion, nameof(targetFrameworkVersion));
        ...
        {
            VerifyThrowArgumentLength(configFile, nameof(configFile));
            VerifyThrowArgumentLength(targetFrameworkVersion, nameof(targetFrameworkVersion));
        ...
        {
            VerifyThrowArgumentLength(targetPlatformIdentifier, nameof(targetPlatformIdentifier));
        ...
        public static string GetPlatformExtensionSDKLocation(string sdkMoniker, string targetPlatformIdentifier, Version targetPlatformVersion, string[] diskRoots, string[] extensionDiskRoots, string registryRoot)
        {
            VerifyThrowArgumentLength(targetPlatformIdentifier, nameof(targetPlatformIdentifier));
            VerifyThrowArgumentNull(targetPlatformVersion, nameof(targetPlatformVersion));
            VerifyThrowArgumentLength(sdkMoniker, nameof(sdkMoniker));
        ...
        {
            VerifyThrowArgumentLength(sdkRoot, nameof(sdkRoot));
            VerifyThrowArgumentLength(targetConfiguration, nameof(targetConfiguration));
            VerifyThrowArgumentLength(targetArchitecture, nameof(targetArchitecture));
        ...
        {
            VerifyThrowArgumentLength(targetPlatformIdentifier, nameof(targetPlatformIdentifier));
            VerifyThrowArgumentLength(targetPlatformVersion, nameof(targetPlatformVersion));
        ...
        {
            VerifyThrowArgumentLength(sdkIdentifier, nameof(sdkIdentifier));
            VerifyThrowArgumentLength(sdkVersion, nameof(sdkVersion));
            VerifyThrowArgumentLength(targetPlatformIdentifier, nameof(targetPlatformIdentifier));
            VerifyThrowArgumentLength(targetPlatformVersion, nameof(targetPlatformVersion));
        ...
        {
            VerifyThrowArgumentNull(sdkIdentifier, nameof(sdkIdentifier));
            VerifyThrowArgumentNull(sdkVersion, nameof(sdkVersion));
        ...
        {
            VerifyThrowArgumentLength(targetFrameworkIdentifier, nameof(targetFrameworkIdentifier));
            VerifyThrowArgumentLength(targetFrameworkVersion, nameof(targetFrameworkVersion));
        ...
        public static IList<string> GetPathToReferenceAssemblies(string targetFrameworkIdentifier, string targetFrameworkVersion, string targetFrameworkProfile, string targetFrameworkRootPath, string targetFrameworkFallbackSearchPaths)
        {
            VerifyThrowArgumentLength(targetFrameworkVersion, nameof(targetFrameworkVersion));
            VerifyThrowArgumentLength(targetFrameworkIdentifier, nameof(targetFrameworkIdentifier));
            VerifyThrowArgumentNull(targetFrameworkProfile, nameof(targetFrameworkProfile));
        ...
        public static IList<string> GetPathToReferenceAssemblies(string targetFrameworkRootPath, FrameworkNameVersioning frameworkName)
        {
            ...
            VerifyThrowArgumentLength(targetFrameworkRootPath, nameof(targetFrameworkRootPath));
        ...
        internal static string ChainReferenceAssemblyPath(string targetFrameworkDirectory)
        {
            ...
            {
                ThrowInvalidOperation("ToolsLocationHelper.InvalidRedistFile", redistFile, ex.Message);
            }
        ...
        {
            VerifyThrowArgumentLength(targetFrameworkRootDirectory, nameof(targetFrameworkRootDirectory));
            VerifyThrowArgumentLength(frameworkIdentifier, nameof(frameworkIdentifier));
