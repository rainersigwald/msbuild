...
namespace Microsoft.Build.Utilities
{
        ...
        IMetadataContainer // expose direct underlying metadata for fast access in binary logger
    {
        ...
        {
            VerifyThrowArgumentNull(itemSpec, nameof(itemSpec));
        ...
        (
            ...
            this(itemSpec)
        {
            VerifyThrowArgumentNull(itemMetadata, nameof(itemMetadata));
        ...
        {
            VerifyThrowArgumentNull(taskItemToCast, nameof(taskItemToCast));
