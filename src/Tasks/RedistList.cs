...
namespace Microsoft.Build.Tasks
{
    ...
    internal sealed class RedistList
    {
        ...
        {
            VerifyThrowArgumentNull(frameworkDirectory, nameof(frameworkDirectory));
                ...
                foreach (AssemblyTableInfo info in whiteListAssemblyTableInfo)
                {
                    ...
                    else
                    {
                        ...
                        if (whiteListErrors.Count == errorsBeforeReadCall)
                        {
                            ...
                            whiteListErrors.Add(new Exception(FormatResourceStringStripCodeAndKeyword("ResolveAssemblyReference.NoSubSetRedistListName", info.Path)));
    ...
    internal class SubsetListFinder
    {
        ...
        {
            VerifyThrowArgumentNull(subsetToSearchFor, nameof(subsetToSearchFor));
